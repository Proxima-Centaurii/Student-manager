...
/**An input verifier that checks if the input consists of letters and numbers. It has the ability to display custom popup warning messages.
 * */
public class AlphanumericVerifier extends InputVerifier{
	...
	public AlphanumericVerifier(boolean allow_white_spaces, boolean display_popup_warning, String message) {
		super();
	...
	public boolean verify(JComponent component) {
		...
		for(char c : val.toCharArray())
			if(!(Character.isAlphabetic(c) || Character.isDigit(c) || (c == ' ' && allow_white_spaces))) {
